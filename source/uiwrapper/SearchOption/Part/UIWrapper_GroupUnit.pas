...
type
  TUIWrapper_SchOpt_Group = class(TUIWrapper_AbsSearchOptionPart)
    private
...
constructor TUIWrapper_SchOpt_Group.Create(owner: TExpander; cmbTimeUnit, cmbFunction: TComboBox);
var
...
function TUIWrapper_SchOpt_Group.GetSearchOptionPart: ISearchOptionPart;
var
