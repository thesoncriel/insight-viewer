...
//    procedure MenuItem5Click(Sender: TObject);
  ...
  protected
    procedure DBList_OnAfterSearch(Sender: TObject; schResult: IDataSetIterator);
    procedure DBList_OnFoundLogMsgData(Sender: TObject; val: Boolean);
  public
    { Public declarations }
  end;
...
begin
  ...
  FDBList.OnAfterSearch := DBList_OnAfterSearch;
  FDBList.OnFoundLogMsgData := DBList_OnFoundLogMsgData;
...
begin
  FDBList.ShowSearchOption;
end;

procedure TForm_Main.DBList_OnAfterSearch(Sender: TObject;
  schResult: IDataSetIterator);
begin
  FStageGridList.SetSearchResult( schResult );
end;

procedure TForm_Main.DBList_OnFoundLogMsgData(Sender: TObject; val: Boolean);
begin
  Button_Graph.Enabled := not val;
end;
